...
<footer className="text-center text-white" style={{background: "#f1f1f1"}}>
  ...
  <div className="text-center text-gray-700 p-4" style={{background: "rgba(0, 0, 0, 0.2)"}}>
    Eco-tienda tecnológica 
    <a className="text-gray-800" href="https://tailwind-elements.com/"> Partefix.com</a>
  </div>
</footer>
</div>
